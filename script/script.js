...
//function to login valif
function login() {
    const username = document.getElementById("username").value;
    const password = document.getElementById("password").value;


    if (username === "alan" && password === "alan123") {
...
function checkUsername() {
    ...
    if (usernameInput.value.trim() === "") {
        ...
        usernameError.textContent = "Empty username";

    }
    else if (!usernameRegex.test(usernameInput.value.trim())) {

        usernameError.textContent = "Username cannot be number or special characters";
...
//function to to show image slide show
